...
delete from parent2  -- on delete cascate sayesinde silebildik,
--SORU2: parent2 tablosunu siliniz
drop table parent2 cascade  -- on delete cascate sayesinde child silinmeden parent tabloyu silebildik,
